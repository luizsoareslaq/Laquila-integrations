...
namespace Laquila.Integrations.Worker.Querys
{
    ...
    {
        public async Task<PagedResult<PrenotaDTO>> GetPrenotas(LAQFilters filters, CancellationToken ct)
        {
            (RestClient client, RestRequest request) = NewRestSharpClient("https://localhost:5001/api/outbound/orders", null, filters, "", "get");
